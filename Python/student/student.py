...
def printRecords(foo):
	...
	print ("Student ID".ljust(10),"Score".ljust(10), "Grade".ljust(10), "standing".ljust(10))
	

	for record in records:
		fields = record.split()
		print (fields[0].ljust(10), fields[1].ljust(10), letter_grade(float(fields[1])).ljust(10), standing(letter_grade(float(fields[1]))))
...
def highestScore(foo):
	...
	print ("\n",list(score.keys())[list(score.values()).index(top)], "has the highest score of", top)
